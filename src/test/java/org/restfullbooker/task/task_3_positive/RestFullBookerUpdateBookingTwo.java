...
public class RestFullBookerUpdateBookingTwo {
    ...
    @Given("Get payload from urlEight {string}")
    public void get_payload_from_url_eight(String baseUri) {
    ...
    @Then("verify responseEight status code \"{int}")
    public void verify_response_eight_status_code(Integer int1) {

        MatcherAssert.assertThat(response.getStatusCode(), Matchers.is(200));
    }
    @Then("verify responseEight contains header content type")
    public void verify_response_eight_contains_header_content_type() {
        MatcherAssert.assertThat(response.getHeaders().hasHeaderWithName("Content-type"),Matchers.is(true));
    }


    @Then("verify responseEight contains firstname")
    public void verify_response_eight_contains_firstname() {
...
// calling method will take time so directly teh value fo final static method will save time while calling
    ...
    @Then("verify responseEight Json Schema")
    public void verify_response_eight_json_schema() {
        // calling method will take time so directly teh value fo final static method will save time while calling
