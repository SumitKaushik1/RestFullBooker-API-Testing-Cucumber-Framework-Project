...
public class RestfullBookerRequestDeleteUserTwo {
// private bz i want to intialize the response in this classs i donot want ot share that resposne accross
    ...
    public RestfullBookerRequestDeleteUserTwo() {
        ...
        this.BOOKING_ID_TO_DELETE = RestFullBookerGetAllBookingOne.getBookingIdToDelete();
    }
