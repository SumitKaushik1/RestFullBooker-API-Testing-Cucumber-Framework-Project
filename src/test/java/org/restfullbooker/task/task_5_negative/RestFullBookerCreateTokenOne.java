...
public class RestFullBookerCreateTokenOne {
    ...
    @Given("Get payload from urlTwelve {string}")
    public void get_payload_from_url_twelve(String baseUri) {
    ...
    @Then("verify responseTwelve status code  {string}")
    public void verify_response_twelve_status_code(String statusCode) {
        ...
        // assertion is done ie the token part should not be null then only we can store it  // Write code here that turns the phrase above into concrete actions
    }
    @Then("verify responseTwelve contains token as key")
    public void verify_response_twelve_contains_token_as_key() {
...
// Write code here that turns the phrase above into concrete actions
    ...
    @Then("verify responseTwelve contains header content type")
    public void verify_response_twelve_contains_header_content_type() {

        //3. (by content ype you get-> true),true since both true matched so assertion is passed
        MatcherAssert.assertThat(response.getHeaders().hasHeaderWithName("Content-type"),Matchers.is( true));
    }
    @Then("verify responseTwelve contains token")
    public void verify_response_twelve_contains_token() {
    ...
    @Then("verify responseTwelve Json Schema")
    public void verify_response_twelve_json_schema() { //1 to 4 ,all request was made till "when"  ie so upto when hamcrest liberary can be used for the validation the response
